...
- 2026-09-15: Verify read-only previews do not upgrade a database transaction to write mode or acquire persistent mutation locks, so cancelled or concurrent previews remain side-effect free.
