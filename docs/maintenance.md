...
> Current maintenance focus (2026-09-15): keep portfolio preview paths strictly read-only, including telemetry, freshness, access, and audit timestamps, while preserving deterministic output from seeded synthetic fixtures.
